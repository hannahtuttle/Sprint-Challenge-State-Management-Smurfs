...
export const deleteData = id => dispatch => {
    ...
    .then(response => {
        ...
        dispatch({ type: DELETE_SMURF_DATA_SUCCESS, payload: response.data})
    })
    .catch(error => {
...
export const editData = id => dispatch => {
    ...
    .then(response => {
        ...
        dispatch({ type: EDIT_SMURF_DATA_SUCCESS, payload: response.data})
    })
    .catch(error => {
        console.log(error.response)
        dispatch({type: EDIT_SMURF_DATA_FAILURE, payload: error.response})
    })
}
